  ...
  return (
    <div className="min-h-screen bg-plouf-background">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-plouf-card rounded-2xl shadow-soft p-6 space-y-8 text-center">
          <section className="flex flex-col items-center">
            <Headphones size={52} className="text-plouf-button-bg mb-4" />
            <h2 className="text-2xl font-bold text-plouf-title mb-4">{text.needHelp}</h2>
            <p className="text-plouf-subtitle text-lg">
              {text.description}
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-plouf-title mb-4">{text.contactUs}</h2>
            <p className="text-plouf-subtitle mb-4">
